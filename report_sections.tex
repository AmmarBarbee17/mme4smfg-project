...
%...............................................................................
\subsection{Thermal Response Model Derivation}
\label{subsec:thermalmodel}
\hypertarget{thermalmodel}{}      % External link: report.pdf#thermalmodel

% ← REPLACE with your detailed thermal model derivation
% This section should contain the full mathematical derivation of the
% first-order thermal response model shown in the presentation.

The thermal response of the system can be modeled using Newton's law of cooling.
Starting from the energy balance:

\begin{equation}
\label{eq:thermal_energy_balance}
...
Defining the thermal time constant \thermalConstant~as:

\begin{equation}
\label{eq:thermal_constant}
\tau = \frac{mc_p}{hA}
\end{equation}

We can rewrite Equation~\ref{eq:thermal_energy_balance} as:
...
Solving this first-order ordinary differential equation with initial condition $T(0) = $ \initialTemp:

\begin{equation}
\label{eq:thermal_solution}
\eqThermalResponse
\end{equation}

This exponential decay model will be validated against experimental data in Section~\ref{sec:results}.

% Add additional derivation steps, assumptions, or boundary conditions as needed
